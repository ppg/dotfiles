...
if command -v ggrep >/dev/null 2>&1; then
  alias grep="ggrep --color=auto --exclude-dir=node_modules --extended-regexp"
  alias grip="ggrep -i --color=auto --exclude-dir=node_modules --extended-regexp"
else
  alias grep="grep --color=auto --exclude-dir=node_modules --extended-regexp"
  alias grip="grep -i --color=auto --exclude-dir=node_modules --extended-regexp"
fi
if command -v rgrep >/dev/null 2>&1; then
  alias rgrep="rgrep -n --color=auto --exclude-dir=node_modules --extended-regexp"
  alias rgrip="rgrep -ni --color=auto --exclude-dir=node_modules --extended-regexp"
else
  alias rgrep="ggrep -nr --color=auto --exclude-dir=node_modules --extended-regexp"
  alias rgrip="ggrep -nir --color=auto --exclude-dir=node_modules --extended-regexp"
fi
